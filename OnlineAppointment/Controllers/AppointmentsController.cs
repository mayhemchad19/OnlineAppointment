...
namespace OnlineAppointment.Controllers
{
    ...
    public class AppointmentsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            //ViewBag.UserID = new SelectList(db.Users.Where(u => u.RoleID == 4 || u.RoleID == 3).OrderBy(u => u.FirstName), "Value", "Text");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AppointmentId,UserID,AppointmentDate,SlotID,Reason,AppointmentStateID")] Appointment appointment)
        {
            if (ModelState.IsValid)
            {
